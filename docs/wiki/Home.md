...
**New in v1.6.2:** `/tlc:build` now automatically parallelizes independent tasks with Opus 4.6 model selection (opus/sonnet/haiku per task complexity). No flags needed.
